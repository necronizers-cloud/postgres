...
sed -i "s|MINIO_ACCESS_KEY_HERE|$(echo -n $MINIO_ACCESS_KEY | base64)|g" minio-access-key.yml
sed -i "s|MINIO_ACCESS_SECRET_HERE|$(echo -n $MINIO_ACCESS_SECRET | base64)|g" minio-access-key.yml
